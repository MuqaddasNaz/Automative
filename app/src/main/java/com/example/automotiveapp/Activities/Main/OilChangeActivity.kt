...
import com.example.automotiveapp.databinding.ActivityOilChangeBinding
...
class OilChangeActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityOilChangeBinding // Declare binding object

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOilChangeBinding.inflate(layoutInflater) // Initialise binding object
        ...
        val btnWatsupp: ImageView = findViewById(R.id.btn_wattsup)

        btnWatsupp.setOnClickListener {
