...
class CarRepairingActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCarRepairingBinding // Declare binding object

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCarRepairingBinding.inflate(layoutInflater) // Initialise binding object
