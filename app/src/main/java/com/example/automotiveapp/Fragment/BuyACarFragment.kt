...
class BuyACarFragment : Fragment(), BuyACarAdapter.BuyACarAdapterListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_buy_a_car, container, false)
        recyclerView = view.findViewById(R.id.rv_carsForBuy)
        setupRecyclerView()
